...
function Navbar() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      ...
      try {
        let res = await apiConnector("GET", categories.CATEGORIES_API); // Fetch data from API
        setSubLinks(res.data.data); // Update state with fetched data
        // //console.log("data",setSubLinks);
      } catch (error) {
        //console.log("Could not fetch Categories.", error); // Handle errors
      }
