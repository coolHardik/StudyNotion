    ...
    <>
      <div className="my-10 flex flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-8 px-12">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <button  type="button"  className="w-fit cursor-pointer italic text-pink-300"  onClick={()=>setConfirmationModal({
            text1:"Do you want to delete this account?",
            text2:"All the data related to this account will be deleted",
            btn1Text:"Delete",
            btn2Text:"Cancel",
